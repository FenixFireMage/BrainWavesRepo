...
import com.bignerdranch.android.brainwaves.ColorPhun.Utilis.BetterColor;
...
public class EasyGameColorPhunActivity extends  MainGameColorPhunActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(EasyGameColorPhunActivity.this, ListOfGamesActivity.class));
    }
}
